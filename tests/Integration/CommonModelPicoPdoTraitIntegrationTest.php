...
class CommonModelPicoPdoTraitIntegrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Clean slate (FK-safe order); avoids stale rows from a failed run.
        ...
        $this->pdo->exec('DROP TABLE IF EXISTS unit_trait_profiles');
        $this->pdo->exec('DROP TABLE IF EXISTS unit_trait_users');
    ...
    public function testSelectWithExtraQuerySuffixAndQuestionMarkPlaceholders()
    {
        ...
        $this->trait->selectAll(
            ...
            ['status' => 'active'],
            null,
            'ORDER BY name LIMIT not_an_integer'
        );
    }
